...
class BottomUpConstructHeap(HeapPriorityQueue):
    """书中没有该类，书中的代码是直接修改 HeapPriorityQueue 类的 __init__() 方法。"""
